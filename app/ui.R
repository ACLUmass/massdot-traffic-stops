...
dashboardPage(
  skin="red",
  # App title
  # dashboardHeader(div(id="title",
  #     div(id = "title_and_icon",
  #         img(src="copcar_icon.png", id="car_icon"),
  #         h2("Traffic Stops in Massachusetts")
  #     )
  # )),
  dashboardHeader(title=div(id = "title_and_icon",
                                    img(src="copcar_icon.png", id="car_icon"),
                                    h2("Traffic Stops in Massachusetts")
                                ),
                  titleWidth="calc(100% - 42.5px)"),
  dashboardSidebar(
    sidebarMenu(
      menuItem("About", tabName = "about", icon = icon("about")),
      menuItem("Download Data", icon = icon("th"), tabName = "download")
    )
  ),
  dashboardBody(
    title = "Traffic Stops in Massachusetts",
    tags$head(
      tags$link(rel = "stylesheet", type = "text/css", href = "massdot_app.css")
    ),
